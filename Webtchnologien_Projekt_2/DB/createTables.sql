...
create table userMovie (
	username varchar(100),
    movieID INTEGER,
    CONSTRAINT pk_userMovie PRIMARY KEY (username,movieID),
    CONSTRAINT fk_userMovie1 FOREIGN KEY (movieID) REFERENCES movie(movieID),
    CONSTRAINT fk_userMovie2 FOREIGN KEY (username) REFERENCES user(username)
)
